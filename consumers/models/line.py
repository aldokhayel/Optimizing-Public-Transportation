...
class Line:
    ...
    def process_message(self, message):
        ...
        if message.topic() == 'cda.station.table': # Set the conditional correctly to the stations Faust Table
            try:
        ...
        elif "oturnstile" in message.topic(): # Set the conditional to the KSQL Turnstile Summary Topic
